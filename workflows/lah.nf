...
include { methodsDescriptionText } from '../subworkflows/local/utils_nfcore_lah_pipeline'
include { DOWNLOAD_UNPACK } from '../modules/local/download_unpack/main'
...
workflow LAH {
	...
	if (params.subsample_n != 0) {
		...
		ch_fastqc_input = SEQKIT_SAMPLE.out.reads
	...
	softwareVersionsToYAML(ch_versions.mix(topic_versions.versions_file))
		...
		.collectFile(
			...
			name: 'lah_software_' + 'mqc_' + 'versions.yml',
			sort: true,
			newLine: true,
		)
